...
title('Convergence rate','fontweight','bold'); xlabel('Number of trials, \it t'); ylabel('Distance from balance point, {^{\epsilon_{\itt}} /_{\epsilon_0}}'); 
...
set(gca,'TickDir','Out'); ticklength;
title('99% convergence','fontweight','bold'); xlabel('\it M,N'); ylabel('Trials to convergence, \it t*');
set(gca,'Color','none');
...
set(gca,'TickDir','Out'); ticklength;
colormap(gca,hot); set(gca,'Color','none');
...
set(gca,'XScale','Log','YTick',0:0.25:1); xlim([1 maxtrials]);
set(gca,'TickDir','Out'); ticklength;
xlabel('Number of trials, \it t'); ylabel('Distance from balance point, {^{\epsilon_{\itt}} /_{\epsilon_0}}'); 
