classdef continuous < handle
    ...
    methods
        ...
        %% class constructor
        function this = continuous(MN_max,gamma,s_max,ds,responsemodel)
        ...
        function this = SimulateProcess(this,M,N,numtrials)
            ...
            for i=1:numtrials
                ...
                if count_incorrect==M, count_incorrect = M-1; count_correct = 0;  stim(i+1) = min(smax, stim(i) + ds); % (reset counter + increase/decrease stim) or (leave unchaged)
                elseif count_correct==N, count_incorrect = 0; count_correct = N-1; stim(i+1) = max(-smax, stim(i) - ds);  else, stim(i+1) = stim(i); end
