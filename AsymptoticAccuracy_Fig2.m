...
axis([1 10 50 100]); set(gca,'XTick',2:2:10); set(gca,'YTick',50:10:100);
title('M-up 10-down','fontsize',16);
...
axis([1 10 60 75]); set(gca,'XTick',2:2:10); set(gca,'YTick',50:5:100);
title('M-up N-down','fontsize',16);
...
% labels
title('Asymptotic Accuracy (Continuous)','fontsize',16);
xlabel('N','fontsize',14), ylabel('M','fontsize',14);
set(gca,'fontsize',14);
axis([0 MNmax+1 0 MNmax+1]); set(gca,'XTick',2:2:10); set(gca,'YTick',2:2:10);
axis square;
...
text(1.5,0.7*MNmax,'Chance (50%)','fontsize',16);
% labels
title('Asymptotic Accuracy (Blocked)','fontsize',16);
xlabel('N','fontsize',14), ylabel('M','fontsize',14);
set(gca,'fontsize',14);
axis([0 MNmax+1 0 MNmax+1]); set(gca,'XTick',2:2:10); set(gca,'YTick',2:2:10);
axis square;
...
text(1.5,0.7*MNmax,'Chance (50%)','fontsize',16);
% labels
title('Asymptotic Accuracy (Non-consecutive)','fontsize',16);
xlabel('N','fontsize',14), ylabel('M','fontsize',14);
set(gca,'fontsize',14);
axis([0 MNmax+1 0 MNmax+1]); set(gca,'XTick',2:2:10); set(gca,'YTick',2:2:10);
axis square;
